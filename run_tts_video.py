...
vd = 25; fd = f'text_to_speech_v{vd}.py'
...
required_files = [fd, fe, ff, 'source.pdf', 'script.txt']
...
filtered_files = [f for f in required_files if f != "source.pdf" and f!=  'script.txt']
